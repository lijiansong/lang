...
/* Hough transform
 *
 * Takes dimentions of the image, the image, initial angle
 * and the angle step in hough transform
 * Computes Hough transform of the image.
 *
 */
...
/* Edge detection
 *
 * Takes image size, the image, and the size of image tobytes
 */
